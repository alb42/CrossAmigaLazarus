...
RUN apt-get install -y wget binutils gcc libgtk2.0-0 libgtk2.0-dev psmisc tightvncserver icewm xterm gdb
...
RUN wget https://build.alb42.de/fpcdocker/crossfpc-3.2.0.tar.gz && tar -zxvf crossfpc-3.2.0.tar.gz -C /usr/ && rm crossfpc-3.2.0.tar.gz
